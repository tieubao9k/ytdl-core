...
const getHTML5player = body => {
  // FORCE PLAYER ID to 0004de42 for old player compatibility
  const FORCED_PLAYER_ID = "0004de42"; // Updated for new patterns

  // Return forced player URL with specific ID
  return `/s/player/${FORCED_PLAYER_ID}/player_ias.vflset/en_US/base.js`;
