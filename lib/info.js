...
/**
 * Gets info from a video using InnerTube multi-client approach (Lavalink-style).
 * This provides direct URLs without signature decryption.
 *
 * @param {string} id
 * @param {Object} options
 * @returns {Promise<Object>}
...
exports.getInfo = async (id, options) => {
  ...
  if (!innerTubeInfo.success || innerTubeInfo._innerTube.directUrls === 0) {
    throw new Error('Failed to get video info with direct URLs from InnerTube');
  }
