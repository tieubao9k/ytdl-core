...
class AntiBotManager {
  ...
  getBrowserUserAgents() {
    const chromeVersions = ['133.0.0.0', '132.0.0.0', '131.0.0.0', '130.0.0.0'];
    const edgeVersions = ['133.0.0.0', '132.0.0.0', '131.0.0.0'];
    const firefoxVersions = ['134.0', '133.0', '132.0', '131.0'];
  ...
  getBrowserHeaders(url = 'https://www.youtube.com') {
    ...
    if (isYoutube) {
      // YouTube-specific headers (updated for 2025)
      Object.assign(baseHeaders, {
        'Sec-Ch-Ua': '"Google Chrome";v="133", "Chromium";v="133", "Not_A Brand";v="24"',
        'Sec-Ch-Ua-Mobile': '?0',
        'Sec-Ch-Ua-Platform': '"Windows"',
        'Sec-Ch-Ua-Full-Version-List': '"Google Chrome";v="133.0.6835.106", "Chromium";v="133.0.6835.106", "Not_A Brand";v="24.0.0.0"',
        'DNT': '1',
        'X-Client-Data': this.generateClientData(),
        'X-Youtube-Client-Name': '1',
        'X-Youtube-Client-Version': '2.20250110.01.00'
      });
    }
